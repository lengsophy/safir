...
Router.route('/',{
    ...
    name:'home',
    waitOn : function () {
        return [TAPi18n.subscribe("products",-1),TAPi18n.subscribe("list_product"),Meteor.subscribe("banner")];
    },
    //fastRender: true
});
...
Router.route('/details/:id', {
    ...
    waitOn : function () {
        ...
        return [TAPi18n.subscribe("products",-1),Meteor.subscribe("attribute",this.params.id),TAPi18n.subscribe("parent_tags"),TAPi18n.subscribe("tags"),TAPi18n.subscribe("parentattr"),Meteor.subscribe("contents")];
    },
    data: function() {
        //======makara========
